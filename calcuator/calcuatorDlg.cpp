...
void CcalcuatorDlg::OnTimer(UINT_PTR nIDEvent)
{
	// TODO: 在此添加消息处理程序代码和/或调用默认值
	    int x,y,x1=450,y1=200,x2=450,y2=200,x3=450,y3=200,x4=450,y4=200,x5=450,y5=200,ox=450,oy=200;
		if(nIDEvent==1)
		{
			int r=30;
			CDC *pDC;
		...
		if(nIDEvent==2)
		{
			...
			newpen2.CreatePen(PS_SOLID,53,RGB(255,255,255));
			pDC2=GetDC();
		...
		if(nIDEvent==3)
		{
			...
			newpen4.CreatePen(PS_SOLID,2,RGB(255,255,255));
			pDC4=GetDC();
